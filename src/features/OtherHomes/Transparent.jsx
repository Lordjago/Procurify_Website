...
const Transparent = ({heading, subheading, image}) => {
  return (
    <div className="mx-4 md:mx-5 mt-25">
      <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4 mx-3 md:mx-10 py-5 items-center rounded-2xl px-2 bg-[#fafafa]`} >
        <div className=" md:mt-12 text-left px-4">
          ...
          <h4 className="text-lg md:text-md font-normal mt-6 w-full md:w-11/12">
            {subheading}
          </h4>
        </div>
