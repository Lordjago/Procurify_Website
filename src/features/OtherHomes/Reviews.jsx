        ...
        <div className="flex items-end justify-between mt-2">
          ...
          <div className="flex items-center space-x-5 mr-10">
            <button 
              ...
              className={`${isFirstPage ? 'opacity-30 cursor-not-allowed' : 'opacity-100 cursor-pointer'}`}
            >
              <IoArrowBackSharp color={isFirstPage ? "#c4c4c4" : "#000"} className="w-7 h-14" />
            </button>
            <button 
              onClick={nextReviews}
              disabled={isLastPage}
              className={`${isLastPage ? 'opacity-30 cursor-not-allowed' : 'opacity-100 cursor-pointer'}`}
            >
              <IoArrowForward color={isLastPage ? "#c4c4c4" : "#000"} className="w-7 h-14" />
            </button>
          </div>
        </div>
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-5">
